...
var Portal = React18.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime7.jsx)(React18.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime7.jsx)(React18.Fragment, {
...
function useMenuItem(params) {
  ...
  const itemMetadata = React21.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React21.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useOption(params) {
  ...
  const selectOption = React24.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useSelect(props) {
  ...
  const optionValues = React26.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React26.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React26.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React26.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const getItemId = React26.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React26.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React26.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React26.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const useListParameters = {
    ...
    onHighlightChange: handleHighlightChange,
    onStateChange: handleStateChange,
    reducerActionContext: React26.useMemo(() => ({
      multiple
    }), [multiple]),
    items: optionValues,
  ...
  const getOptionMetadata = React26.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React26.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function useSnackbar(parameters = {}) {
  ...
  const timerAutoHide = React29.useRef();
  React29.useEffect(() => {
    if (!open) {
      return void 0;
    }
...
function TabsProvider(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime10.jsx)(TabsContext.Provider, {
...
var Tabs = React34.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime11.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime11.jsx)(TabsProvider, {
      value: contextValue,
      children
    })
  }));
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React36.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React36.useCallback((tabValue) => {
  ...
  const handleChange = React36.useCallback((event, newValue) => {
    var _newValue$;
  ...
  const isItemDisabled = React36.useCallback((item) => {
  ...
  const contextValue = React36.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function useTab(parameters) {
  ...
  const tabRef = React38.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React38.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var TextareaAutosize = React39.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const renders = React39.useRef(0);
  const [state, setState] = React39.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React39.useCallback(() => {
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React52.useState(value ? String(value) : void 0);
  React52.useEffect(() => {
...
var COMPONENT_NAME14 = "Popup";
function getPopupUtilityClass(slot) {
  return generateUtilityClass(COMPONENT_NAME14, slot);
}
var popupClasses = generateUtilityClasses(COMPONENT_NAME14, ["root", "open"]);
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React59.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React59.useRef(false);
  const handleEntering = React59.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React59.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React59.useCallback(() => {
    dispatch("exiting");
  }, []);
...
var selectClasses = generateUtilityClasses(COMPONENT_NAME15, ["root", "button", "listbox", "popper", "active", "expanded", "disabled", "focusVisible"]);
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime33.jsx)(React62.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-U5TA3UHC.js.map
